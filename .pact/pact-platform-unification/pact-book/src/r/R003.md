...
| 验收方式 | 判定标准 | 检查者 |
|---|---|---|
| router benchmark test | generic/admin/business 三类 profile 正确 | 脚本 |

## 依赖关系

- **依赖**（要先做完这些）：[R002](../r/R002.md)
- **被依赖**（这条不稳，下面这些都会塌）：[R004](../r/R004.md)、[R009](../r/R009.md)
...
graph LR
  ...
  R003 --> R004["R004"]
  R003 --> R009["R009"]
  style R003 fill:#fde68a,stroke:#b45309
```
