...
public class OperLogAspect {
    ...
    @Pointcut("execution(* com.vima.starter.controller..*(..)) && !execution(* com.vima.starter.controller.AuthController.*(..)) && !execution(* com.vima.starter.controller.HealthController.*(..))")
