...
import com.vima.starter.entity.*;
import com.vima.starter.repository.*;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        testUser.setEmail("test@vima.com");
    ...
    private void initConfigs() {
        ...
        siteName.setConfigValue("Vima Admin");
